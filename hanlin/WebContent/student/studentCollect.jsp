					...
					<div class="col-md-10">
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">HTML5与CSS3</h4>
								<a href="#"><img src="../img/defaulthead.jpg"
									class="img-circle" width="35px" height="30px" />&nbsp;范娟</a> <br>
								<br> <font style="size: 20px;">2015-12-29</font>
							</div>
						</div>
					</div>
					<div class="col-md-1">
						<br> <a href="#">进行学习</a><br> <br> <a href="#"
							data-toggle="modal" data-target="#myModal">取消收藏</a>
					</div>
				</div>
				<div class="row course_learning">
					<div class="col-md-10">
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">Java快速学习</h4>
								<a href="#"><img src="../img/defaulthead.jpg"
									class="img-circle" width="35px" height="30px" />&nbsp;范娟</a> <br>
								<br> <font style="size: 20px;">2015-12-4</font>
							</div>
						</div>
					</div>
					<div class="col-md-1">
