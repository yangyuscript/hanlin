...
<body>
			...
			<div id="content_part" class="col-md-9">
				<div class="row">
					<div class="col-md-8" style="margin-top:15px;margin-bottom:15px;">
						<strong>当前位置:</strong><a href="#">我的课程</a>&gt;<a href="#">收藏课程</a>
					</div>
					<!-- <div class="col-md-4">
				...
				<%-- <input type="text" value="<s:property value='#session.myLikeCourseInfoList.size()'/>"/> --%>
				<s:if test="#session.myLikeCourseInfoList.size()==0">
				   <h4 style="color:red;">您暂时还没有学习任何课程，快去寻找喜欢的课程吧！！！</h4>
				</s:if>
				<s:else>
				<s:iterator value="#session.myLikeCourseInfoList">
				...
				<div class="row course_learning">
						...
						<div class="media">
							<div class="media-left mask-wrapper">
								<a href="#"> <img class="media-object"
									src="../head/<s:property value='course.courseHead'/>" alt="...">
								</a>
								<div class="mask-inner">
									<p>
										<a href="course_getCourseDetailInfo.do?courseId=<s:property value='courseId'/>&&userId=<s:property value='#session.loginUser.userId'/>"><span class="glyphicon glyphicon-facetime-video"
					...
					<div class="col-md-1">
						...
						<!-- <a class="quit_course" href="#" data-toggle="modal" data-target="#myModal">取消收藏</a> -->
						<a class="quit_course" href="course_cancleLikeCourse.do?myLikeCourseId=<s:property value='myLikeCourseId'/>&userId=<s:property value='#session.loginUser.userId'/>">取消收藏</a>
						<input type="hidden" value="<s:property value='course.courseId'/>"/>
				   ...
				   <div class="row course_learning">
					<div class="col-md-10">
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading"><s:property value='course.courseName'/><h3 style="color:red;">课程已被暂时屏蔽</h3></h4>
								<a href="#"><img src="../head/<s:property value='user.head'/>"
									class="img-circle" width="35px" height="30px" />&nbsp;<s:property value='user.nickname'/></a> <br>
								<br>
								<font style="size: 20px;"><s:property value="course.time"/></font>
	...
	<!-- footer区结束 -->
	<div id="myModal" class="modal fade myModal" tabindex="-1" role="dialog"
							...
							<div class="modal-dialog modal-sm">
								<div class="modal-content">
									...
									<form action="" method="post">
										...
										<p><input id="sub_comment" class="btn btn-default" type="button" value="提交"/></p>
									</form>
								</div>
							</div>
						</div>
