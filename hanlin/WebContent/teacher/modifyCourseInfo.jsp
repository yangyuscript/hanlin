			...
			<div id="content_part" class="col-md-9">
				<div class="row">
					<div class="col-md-12" style="margin-top:15px;margin-bottom:15px;">
						<strong>当前位置:</strong><a href="#">我的课程</a>&gt;<a href="#">修改课程信息</a>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8">
						<form class="form-horizontal" action="<%=basePath%>/teacher_modifyCourseInfoA.do" method="post" enctype="multipart/form-data" onsubmit="return check(this)">
							<input type="hidden" name="course.courseId" value="<s:property value='#session.course.courseId'/>"/>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">课程名称</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" required name="course.courseName" value="<s:property value='#session.course.courseName'/>"
										placeholder="课程名称">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<select class="form-control" name="course.courseType">
									   <s:iterator value="#session.allCourseTypes">
									      <s:if test="courseTypeId==<s:property value='#session.course.courseType'/>">
									         <option value="<s:property value='courseTypeId'/>" selected="selected"><s:property value="courseTypeName"/></option>
									      </s:if>
									      <s:else>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea class="form-control" required rows="3" name="course.courseIntroduction" 
										placeholder="课程介绍"><s:property value="#session.course.courseIntroduction"/></textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">课程要求</label>
								<div class="col-sm-10">
									<textarea class="form-control" required rows="3" name="course.courseTips"
										placeholder="课程要求"><s:property value="#session.course.courseTips"/></textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">课程主图</label>
								<div class="col-sm-10">
									<input type="file" name="image" id="courseHead" /><img src="<%=basePath %>/head/defaultcourse.jpg" width="300px" height="180px" id="img0"/>
									<script>
									   $(function(){
