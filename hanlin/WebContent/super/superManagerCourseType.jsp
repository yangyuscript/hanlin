...
<body>
			...
			<div id="content_part" class="col-md-9">
				<div class="row">
					<div class="col-md-8 col-xs-12" style="margin-top:15px;margin-bottom:15px;">
						<strong>当前位置:</strong><a href="#">课程种类管理</a>
					</div>
					<div class="col-md-2">
						<input type="button" class="btn btn-default"
							data-toggle="modal" data-target="#addCT" value="添加" />
					</div>
				</div>
				<hr>
				<div class="row">
					<div class="col-md-10">
						<table class="table table-hover table-bordered">
							...
							<s:iterator value="#session.allCourseTypes">
							  <tr>
								<td><s:property value="courseTypeId"/></td>
								<td><s:property value="courseTypeName"/></td>
								<td><input type="button"
									class="btn btn-default mct" data-toggle="modal" data-target=".modifyCT" value="修改" />
									<input type="hidden" value="<s:property value='courseTypeName'/>"/>
							        <input type="hidden" value="<s:property value='courseTypeId'/>"/></td>
							  </tr>
							</s:iterator>						
						</table>
					</div>
	...
	<!-- footer区结束 -->
	<div id="addCT" class="modal fade bs-example-modal-sm" tabindex="-1"
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">添加课程种类</h4>
				</div>
				<form action="<%=basePath %>/super_addCourseType.do" method="post">
				<div class="modal-body">
					<p>课程种类名:<input type="text" class="form-control" name="courseTypeName" id="coursetype_input" pattern="^([\u4e00-\u9fa5]|[0-9_a-zA-Z]){1,10}$" required placeholder="新增课程种类名"/></p>
				</div>
	...
	<div class="modal fade bs-example-modal-sm modifyCT" tabindex="-1"
		role="dialog" aria-labelledby="mySmallModalLabel">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">修改课程种类</h4>
				</div>
				<form action="<%=basePath %>/super_modifyCourseTypeName.do" method="post">
				<div class="modal-body">
				    <input type="hidden" name="courseTypeId" id="courseTypeId" value=""/>
					<p>课程种类名:<input type="text" class="form-control" name="courseTypeName" id="courseTypeName" pattern="^([\u4e00-\u9fa5]|[0-9_a-zA-Z]){1,10}$" required value="修改课程种类名"/></p>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
	...
	<script type="text/javascript">
	    coursetype_input.oninput=function(){
	    	coursetype_input.setCustomValidity("");
	    }
	    coursetype_input.oninvalid=function(){
	    	coursetype_input.setCustomValidity("请输入1~10个字或字母或数字的课程名!");
	    }
	    courseTypeName.oninput=function(){
	    	courseTypeName.setCustomValidity("");
	    }
	    courseTypeName.oninvalid=function(){
	    	courseTypeName.setCustomValidity("请输入1~10个字或字母或数字的课程名!");
	    }
		$(function() {
			...
			$(".mct").click(function(){
				...
				$("#courseTypeName").val($(this).next().val());
				$("#courseTypeId").val($(this).next().next().val());
			});
		});
	</script>
